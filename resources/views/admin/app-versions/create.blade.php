        ...
        <div class="card-body">
            <form action="{{ route('admin.app-versions.store') }}" method="POST" enctype="multipart/form-data" id="upload-form">
                ...
                <div class="d-flex justify-content-end gap-2">
                    <a href="{{ route('admin.app-versions.index') }}" class="btn btn-secondary" id="cancel-btn">
...
(function() {
    ...
    console.log('[INLINE] Upload progress script loaded');
    ...
    console.log('[INLINE] Elements found:', {
        form: !!form,
        fileInput: !!fileInput,
        uploadBtn: !!uploadBtn,
    ...
    fileInput.addEventListener('change', function(e) {
        console.log('[INLINE] File selected:', this.files.length);
        if (this.files.length > 0) {
            const file = this.files[0];
            console.log('[INLINE] File info:', file.name, file.size);
    ...
    form.addEventListener('submit', function(e) {
        ...
        if (!form.checkValidity()) {
            console.log('[INLINE] Form validation failed');
            form.classList.add('was-validated');
            return;
        }

        console.log('[INLINE] Starting upload...');
        ...
        xhr.addEventListener('load', function() {
            console.log('[INLINE] Upload complete, status:', xhr.status);
